...
class Container(ConfiguredBaseModel):
    ...
    temperature_dataset: TemperatureDataset = Field(
        default=..., json_schema_extra={"linkml_meta": {"domain_of": ["Container"]}}
    )
...
class TemperatureDataset(ConfiguredBaseModel):
    ...
    latitude_in_deg: str = Field(
        default=..., json_schema_extra={"linkml_meta": {"domain_of": ["TemperatureDataset"]}}
    )
    ...
    day_in_d: Optional[DaysInDSinceSeries] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["TemperatureDataset"]}}
    )
                ...
                "annotations": {
                    "labeled_by": {
                        ...
                        "value": [
                            ...
                            {"alias": "date", "labeled_dimensions": [2], "labeling_slot": "date"},
                            {
                                "alias": "day",
...
class DaysInDSinceSeries(ConfiguredBaseModel):
    ...
    reference_date: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["DaysInDSinceSeries"]}},
    )
...
class TemperaturesInKMatrix(ConfiguredBaseModel):
    ...
    conversion_factor: Optional[float] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["TemperaturesInKMatrix"], "unit": {"ucum_code": "K"}}
        },
    )
